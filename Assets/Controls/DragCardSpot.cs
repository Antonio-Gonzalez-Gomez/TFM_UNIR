...
public class DragCardSpot : MonoBehaviour
{
    ...
    private void UpdateCardsPositions()
    {
        for (int i = 0; i < cardList.Count; i++)
        {
            ...
            //Para evitar que las cartas se queden en los extremos del hueco (sin centrarse), se intercalan los indices
            ...
            if (cardsInFan)
            {
                ...
                float cardAngle = 2 * maxRotation * halfInd / cardList.Count - maxRotation;
